...
export const NIGERIAN_STATES: Record<string, string[]> = {
  ...
  Adamawa: [
    ...
    "Hong", "Jada", "Larmurde", "Madagali", "Maiha", "Mayo Belwa",
  ...
  Imo: [
    ...
    "Ohaji/Egbema", "Okigwe", "Orlu", "Orsu", "Oru East",
  ...
  Jigawa: [
    ...
    "Gwiwa", "Hadejia", "Jahun", "Kafin Hausa", "Kazaure",
    "Kiri Kasama", "Kiyawa", "Kaugama", "Maigatari", "Malam Madori",
  ...
  Plateau: [
    ...
    "Jos South", "Kanam", "Kanke", "Langtang South", "Langtang North",
  ...
  Rivers: [
    ...
    "Emuoha", "Etche", "Gokana", "Ikwerre", "Khana",
